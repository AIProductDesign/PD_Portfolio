import { content } from "./content.js?v=2026-06-04-supervisors";
...
const dictionary = {
  en: {
    ...
    presentationOnRequest: "Presentation on request",
  ...
  nl: {
    ...
    presentationOnRequest: "Presentatie op aanvraag",
...
function assetLink(asset, label, missingLabel = "") {
  if (!asset) return `<span class="asset-missing">${missingLabel || `${t("pendingAsset")} ${label}`}</span>`;
    ...
    <section class="brief-section">
      ...
      <div class="brief-grid">
        <article class="brief-card is-wide">
          ...
          ${assignment.brief.supervisors ? `<span>${t("supervisors")}</span><strong>${assignment.brief.supervisors}</strong>` : ""}
    ...
    <article class="project-detail">
      ...
      <section class="asset-section">
        ...
        <div class="asset-grid">
          ${assetLink(project.assets.presentation, t("presentation"), t("presentationOnRequest"))}
        </div>
